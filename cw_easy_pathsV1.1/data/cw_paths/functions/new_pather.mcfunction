...
summon minecraft:wandering_trader ~ ~ ~ {Silent:1b,Invulnerable:1b,Team:"cw_pather",PersistenceRequired:1b,CanPickUpLoot:0b,Willing:0b,DespawnDelay:2147483647,Tags:["cw_pather","new"],Offers:{},Attributes:[{Name:generic.movement_speed,Base:0.7}],ActiveEffects:[{Id:14b,Amplifier:1b,Duration:1000000,ShowParticles:0b}]}
